(function () {
  ...
  // Eintrags ganz am Anfang (offsetTop 0) als Standard-Fallback, BEVOR
  // die erste echte Section erreicht wird. "prototyp" bekommt zusätzlich
  // seinen echten Abschnitt (#hifi) registriert, damit es beim Scrollen
  // durch diesen Bereich auch wirklich aktiv markiert wird, statt
  // dauerhaft übersprungen zu werden.
