...
function setNowIntro(){
  ...
  if(!el) return;
  if(currentLang === 'de'){
    el.innerHTML = 'Was mich gerade beschäftigt, woran ich arbeite und worüber ich nachdenke. Kein Social Media, keine Highlights —<br>nur der ehrliche Stand der Dinge. Eine Idee von Derek Sivers — <a href="https://nownownow.com/about" target="_blank" style="color:var(--green-mid);text-decoration:none;">mehr erfahren ↗</a>';
  } else {
